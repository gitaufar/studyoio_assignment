    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-2 sm:gap-3 pt-3 sm:pt-4">
        <button
          type="submit"
          disabled={loading}
          className="bg-primary text-white px-4 sm:px-5 md:px-6 py-2 rounded-lg hover:bg-green-600 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm sm:text-base"
        >
